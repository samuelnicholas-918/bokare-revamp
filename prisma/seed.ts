...
const courses: CourseSeed[] = [
  ...
  },
  {
    ...
    materials: [
      ...
      { type: "LECTURE_NOTES", title: "Equilibrium of Firm", externalUrl: `${BASE}/Sem2/2_4firm.html`, order: 5 },
      { type: "LECTURE_NOTES", title: "Perfect Competition", externalUrl: `${BASE}/Sem2/2_5perfect.html`, order: 6 },
      { type: "LECTURE_NOTES", title: "Imperfect Competition", externalUrl: `${BASE}/Sem2/2_6imperfect.html`, order: 7 },
      { type: "LECTURE_NOTES", title: "Oligopoly", externalUrl: `${BASE}/Sem2/2_7oligopoly.html`, order: 8 },
      { type: "LECTURE_NOTES", title: "Pricing Strategies", externalUrl: `${BASE}/Sem2/2_8pricing.html`, order: 9 },
      { type: "PDF", title: "Semester 2 Complete Notes (PDF)", fileUrl: `${BASE}/Sem2/semTwo.pdf`, order: 10 },
    ],
  },
  {
    semester: 3,
